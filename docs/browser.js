...
const ARTISTS = [];
const RELEASES = [{cover:'cover_160.jpg?9exo7NNKS2g',title:'Jet - Single',tracks:[{number:'',title:'Jet',url:'jet-single/1/'}],url:'jet-single/'},{cover:'cover_160.jpg?S7EHIPbWNpU',title:'String Theory - Single',tracks:[{number:'',title:'String Theory',url:'string-theory-single/1/'}],url:'string-theory-single/'},{cover:'cover_160.jpg?ISL4NuzoEyc',title:'Regrets - Single',tracks:[{number:'',title:'regrets',url:'regrets-single/1/'}],url:'regrets-single/'},{cover:'cover_160.jpg?4fphXn3UCow',title:'Glitching Past Red Rock - Single',tracks:[{number:'',title:'Glitching past Red Rock',url:'glitching-past-red-rock-single/1/'}],url:'glitching-past-red-rock-single/'},{cover:'cover_160.jpg?EIji4W79BD4',title:'Angry Paintbrush - EP',tracks:[{number:'1.',title:'Lesser Sound of London',url:'angry-paintbrush-ep/1/'},{number:'2.',title:'Revolution',url:'angry-paintbrush-ep/2/'},{number:'3.',title:'All For U',url:'angry-paintbrush-ep/3/'},{number:'4.',title:'Pickups',url:'angry-paintbrush-ep/4/'},{number:'5.',title:'The Further You Fall (instrumental)',url:'angry-paintbrush-ep/5/'},{number:'6.',title:'Chewing Baseboards',url:'angry-paintbrush-ep/6/'},{number:'7.',title:'Theremin Crown',url:'angry-paintbrush-ep/7/'}],url:'angry-paintbrush-ep/'},{cover:'cover_160.jpg?JWRStINd6yY',title:'Drip Drop - EP',tracks:[{number:'1.',title:'Hypnotoad on a Hot Plate',url:'drip-drop-ep/1/'},{number:'2.',title:'Crank the Glitch',url:'drip-drop-ep/2/'},{number:'3.',title:'Souls Beat Slow',url:'drip-drop-ep/3/'},{number:'4.',title:'No Slippers at Midnight',url:'drip-drop-ep/4/'},{number:'5.',title:'Retroracle',url:'drip-drop-ep/5/'},{number:'6.',title:'Do Nanobees Dream of Electric Honey',url:'drip-drop-ep/6/'},{number:'7.',title:'Under a Delusion of Sleep',url:'drip-drop-ep/7/'},{number:'8.',title:'Crashing a Car Through a Gameshow Studio',url:'drip-drop-ep/8/'}],url:'drip-drop-ep/'},{cover:'cover_160.jpg?7W6L2nyWgzg',title:'Souls Beat Slow - Single',tracks:[{number:'',title:'Souls Beat Slow',url:'souls-beat-slow-single/1/'}],url:'souls-beat-slow-single/'}];
