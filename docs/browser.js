...
const RELEASES = [
    ...
    number: '',
    title: 'String Theory',
    url: 'string-theory-single/1/'
}

    ],
    url: 'string-theory-single/'
}
,
{
    
    cover: 'cover_160.jpg?ISL4NuzoEyc',
    title: 'Regrets - Single',
    tracks: [
        {
...
,
{
    ...
    cover: 'cover_160.jpg?4fphXn3UCow',
    ...
    url: 'glitching-past-red-rock-single/1/'
}

    ],
    url: 'glitching-past-red-rock-single/'
}
,
{
    
    cover: 'cover_160.jpg?EIji4W79BD4',
    title: 'Angry Paintbrush - EP',
    tracks: [
        {
...
,
{
    ...
    number: '',
    title: 'Souls Beat Slow',
    url: 'souls-beat-slow-single/1/'
}

    ],
    url: 'souls-beat-slow-single/'
}
